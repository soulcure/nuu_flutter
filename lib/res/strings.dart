...
Map<String, Map<String, Map<String, String>>> localizedValues = {
  'en': {
    'US': {
      ...
      //login
      Ids.promptEmail: 'prompt_email',
      Ids.promptPassword: 'prompt_password',
      Ids.actionSignIn: 'action_sign_in',
      Ids.actionSignInShort: 'action_sign_in_short',
      Ids.actionRegister: 'action_register',
      Ids.lostPassword: 'lost_password',
      Ids.lostEmail: 'lost_email',
      Ids.logoutMsg: 'logout_msg',
      Ids.welcome: 'welcome',
      Ids.invalidUsername: 'invalid_username',
      Ids.invalidPassword: 'invalid_password',
      Ids.loginFailed: 'login_failed',
    }
  },
  'zh': {
    'CN': {
